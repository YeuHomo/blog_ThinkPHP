...
<div class="menu_box">
    <ul>
        <li>
            ...
            <ul class="sub_menu">
                <li><a href="/Admin/Category/cateAdd" target="main"><i class="fa fa-fw fa-plus-square"></i>添加分类</a></li>
                <li><a href="/Admin/Category/cateList" target="main"><i class="fa fa-fw fa-list-ul"></i>分类列表</a></li>
                <li><a href="/index.php/Admin/Article/artAdd" target="main"><i class="fa fa-fw fa-list-alt"></i>添加文章</a></li>
                <li><a href="/Admin/Article/artList" target="main"><i class="fa fa-fw fa-image"></i>文章列表</a></li>
            </ul>
        </li>
        <li>
...
<!--主体部分 开始-->
<div class="main_box">
    <iframe src="/index.php/admin/index/info.html" frameborder="0" width="100%" height="100%" name="main"></iframe>
</div>
<!--主体部分 结束-->

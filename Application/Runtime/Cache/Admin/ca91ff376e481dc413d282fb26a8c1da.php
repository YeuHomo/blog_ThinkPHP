    ...
    <div class="result_wrap">
        <div class="result_content">
            <table class="list_tab">
                ...
                <?php if(is_array($artList)): $i = 0; $__LIST__ = $artList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?><tr>
                    <td class="tc"><?php echo ($art["art_id"]); ?></td>
                    <td>
                        <a href="#"><?php echo ($art["art_title"]); ?></a>
                    </td>
                    <td><?php echo ($art["art_view"]); ?></td>
                    <td><?php echo ($art["art_editor"]); ?></td>

                    <td><?php echo (date('Y-m-d H:i:s',$art["art_time"])); ?></td>

                    <td>
                        <a href="/Admin/Article/artEdit?art_id=<?php echo ($art["art_id"]); ?>">修改</a>
                        <a href="javascript:;" onclick="art.artDel(<?php echo ($art["art_id"]); ?>)">删除</a>
                    </td>
